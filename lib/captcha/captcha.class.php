...
//
                    $captchaBox = '	
                                <br>
								<img src="'.$this->imageURL.'/'.$imageName.'" width="80" height="32" style1="border: 1px solid #000; margin: 2px;" alt="CAPTCHA Image">	
		...
		function generateImage($key) {
            ...
            imagestring($image, 15, 0, 0, $formattedKey, $textColor);
			// Save the image.
